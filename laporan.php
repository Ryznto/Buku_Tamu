...
<div class="container-fluid">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <form method="post" action="">
                                    <div class="form-row align-items-center">
                                        <div class="col-auto">
                                            <div class="font-weigth-bold text-primary
                                        text-uppercase mb-1">
                                                priode </div>
                                        </div>
                                        <div class="col-auto">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="<?= isset($_POST['tampilkan']) ? $link : 'export-file.php'; ?>" target="_blank" class="btn btn-success btn-icon-split">
                <span class="icon text-white-50">
                    <i class="fas fa-file-excel"></i>
                </span>
                <span class="text">Export Laporan</span>
            </a>
            <!-- <span class="text">Tabel Histori Kamu</span> -->
        </div>
        <div class="card-body">
